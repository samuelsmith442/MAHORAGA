...
const API_BASE = import.meta.env.VITE_API_URL ? `${import.meta.env.VITE_API_URL}/agent` : '/api'

function getApiToken(): string {
  return localStorage.getItem('mahoraga_api_token') || import.meta.env.VITE_MAHORAGA_API_TOKEN || (window as unknown as { VITE_MAHORAGA_API_TOKEN?: string }).VITE_MAHORAGA_API_TOKEN || ''
}
